...
output_file_path = 'reformatted_data-second.xlsx'  # Path for the new formatted file
...
with pd.ExcelWriter(output_file_path, engine='openpyxl') as writer:
    for sheet_name, data in df.items():
        ...
        df_filtered = pd.concat([df_filtered, total_cost_row], ignore_index=True)
        ...
        # Merge cells for the Subscription ID
        worksheet.merge_cells(start_row=last_row, start_column=1, end_row=last_row, end_column=num_columns)
